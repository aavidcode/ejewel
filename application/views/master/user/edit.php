            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control numbers-only" name="telephone" placeholder="Telephone Number" maxlength="8" value="<?php echo $std[1]; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="website" placeholder="http://www.example.com" value="<?php echo str_replace('http://', '', $userObj->WEBSITE); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="gjepc_mem_no" style="display: none;" class="form-control required" placeholder="Membership No:" <?php echo $userObj->MEM_GJEPC_NO; ?>/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="gjf_mem_no" style="display: none;" class="form-control required" placeholder="Membership No:" value="<?php echo $userObj->MEM_GJF_NO; ?>"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div name="local_ass_mem_no" style="display: none;">
                                <div class="col-sm-3">
                                    <input type="text" name="mem_loc_ass_name" class="form-control required" placeholder="Specify Name of Association" value="<?php echo $userObj->MEM_LOC_ASS_NAME; ?>"/>
                                </div>
                                <div class="col-sm-3">
                                    <!--<input type="text" name="mem_loc_ass_city" class="form-control required" placeholder="City" value="<?php echo $userObj->MEM_LOC_ASS_CITY; ?>"/>-->
