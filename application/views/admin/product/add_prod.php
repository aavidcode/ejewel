...
<div class="contentpanel">
    ...
    <div class="row" id="prod_data_det">
        ...
        <div class="col-md-12" id="prod_summary">
            ...
            <form id="prod_summary_form" onsubmit="return false;">
                <div class="panel panel-default">
                        ...
                        <div class="row mb15">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control required chosen-select-dis-search" name="category">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control required chosen-select-dis-search" name="prod_type">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control chosen-select-dis-search" name="prod_cert">
                                            <option value="">--</option>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control chosen-select-dis-search" name="prod_stock">
                                            <option value="">--</option>
                    ...
                    <div class="panel-footer" style="display: block;">
                        <ul class="pager wizard">
                            <li class="next right"><button class="btn btn-primary" data-next="prod_comp_det" type="submit">Next</button></li>
                        </ul>
                    </div><!-- panel-footer -->
                </div><!-- panel-default -->
            </form>
        ...
        <div class="form-group" id="prod_comp_det" style="display: none;">
            <form id="prod_comp_det_form" onsubmit="return false;">
                <div class="col-md-4">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="display: block;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control required chosen-select-dis-search" id="comp_type" name="comp_type">
                                        <option value="">--</option>
                                        <?php
                            ...
                            <div id="metal_fields" class="mb10 form_fields" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="metal_prim">
                                            <option value="">--</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="metal_type">
                                            <option value="">--</option>
                                            <?php
                            ...
                            <div id="diamond_fields" class="form_fields" style="display: none;">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4">Type</label>
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="stone_type">
                                            <option value="">--</option>
                                            <?php
                                            foreach ($sub_comp_arr as $sub_comp) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="stone_shape">
                                            <option value="">--</option>
                                            <?php
                                ...
                                <div class="form-group" id="stone_size_type" style="display: none;">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="stone_size_type">
                                            <option value="">--</option>
                                            <?php
                                ...
                                <div class="form-group" style="display: none;" id="stone_1_size">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control required chosen-select-dis-search" name="stone_seiv_size_from">
                                            <option value="">--</option>
                                            <?php
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control required chosen-select-dis-search" name="stone_seiv_size_to">
                                            <option value="">--</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control required chosen-select-dis-search" name="stone_color_from">
                                            <option value="">--</option>
                                            <?php
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control required chosen-select-dis-search" name="stone_color_to">
                                            <option value="">--</option>
                                            <?php
                                            foreach ($stone_color_arr as $stone_color) {
                                                echo '<option value="' . $stone_color->COLOR_ID . '">' . $stone_color->COLOR_NAME . '</option>';
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control required chosen-select-dis-search" name="stone_clarity_from">
                                            <option value="">--</option>
                                            <?php
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control required chosen-select-dis-search" name="stone_clarity_to">
                                            <option value="">--</option>
                                            <?php
                                            foreach ($stone_clarity_arr as $stone_clarity) {
                                                echo '<option value="' . $stone_clarity->CLARITY_ID . '">' . $stone_clarity->CLARITY_NAME . '</option>';
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="stone_cut">
                                            <option value="">--</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="stone_fluorescence">
                                            <option value="">--</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="stone_placement">
                                            <option value="">--</option>
                                            <?php
                            ...
                            <div id="colored_stone_fields" class="form_fields" style="display: none;">
                                <div class="form-group">
                                    <label class="col-sm-4">Type</label>
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="colored_stone_type" id="colored_stone_type">
                                            <option value="">--</option>
                                            <?php
                                            foreach ($sub_comp_arr as $sub_comp) {
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4">Color</label>
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="colored_stone_color">
                                            <option value="">--</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4">Shape</label>
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="colored_stone_shape">
                                            <option value="">--</option>
                                            <?php
                                            $stone_shape_arr = $sub_com_data['stone_shape'];
                                            foreach ($stone_shape_arr as $stone_shape) {
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4">Cut</label>
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="colored_stone_cut">
                                            <option value="">--</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4">Placement</label>
                                    <div class="col-sm-8">
                                        <select class="form-control required chosen-select-dis-search" name="colored_stone_placement">
                                            <option value="">--</option>
                                            <?php
                                            $stone_placement_arr = $sub_com_data['stone_placement'];
                                            foreach ($stone_placement_arr as $stone_placement) {
                ...
                <div class="col-md-8" id="prod_summary">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer" style="display: block;">
                            <ul class="pager">
                                <li class="next right"><button class="btn btn-primary" data-next="prod_comp_price" type="button">Next</button></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="display: block;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control required chosen-select-dis-search" name="price_type">
    ...
    <div class="panel panel-default" id="image_upload_det" style="display: none;">
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-7">
                <form action="admin/upload_prod_images/" id="productForm" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-footer">
            <button class="btn btn-primary" style="float:right;" onclick="validateUpload();">Finish</button>
        </div><!-- panel-footer -->
    </div><!-- panel -->
...
<script>
                ...
                jQuery(document).ready(function() {
                    ...
                    prod_summary_form = $("#prod_summary_form");
                    ...
                    $('.next button').on('click', function() {
                        ...
                        if (!prod_summary_form.valid() && id === 'prod_comp_det') {
                            return;
                        } else if ($('#component_grid > table > tbody').html() === '' && id === 'prod_comp_price') {
                            alert('Add Components for product');
                            return;
                        }
                    ...
                    $('#colored_stone_cat').on('change', function() {
                        ...
                        if (selVal === 'Emerald') {
                            alert('Emeraled');
                            $("[name='colored_stone_color]'").find("option[text=Green]").attr("selected", true);
                        } else if (selVal === 'Ruby') {
                            $("[name='colored_stone_color]'").find("option[text='Red']").attr("selected", true);
                        } else if (selVal === 'Sapphire') {
                            $("[name='colored_stone_color]'").find("option[text='Blue']").attr("selected", true);
                        }
                    });
