            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control numbers-only" name="telephone" placeholder="Telephone Number" maxlength="10" value="<?php echo $std[1]; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" maxlength="10" class="form-control numbers-only" name="pincode" placeholder="Pin Code" value="<?php echo $userObj->PINCODE; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <span style="line-height: 30px;">http://</span><input style="margin-left:5px; display: inline-block; width:70%;" type="text" class="form-control" name="website" placeholder="http://www.example.com" value="<?php echo $userObj->WEBSITE; ?>" />
                        </div>
                    </div>
