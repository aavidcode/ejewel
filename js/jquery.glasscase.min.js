(function (c, p, d, q) {
    function n(b, a) { this.element = b.wrap("<div class='glass-case'></div>").parent(); this.init(a) } n.defaults = { widthDisplay: 400, heightDisplay: 534, isAutoScaleDisplay: "true", isAutoScaleHeight: "true", isDownloadEnabled: "true", downloadPosition: 3, nrThumbsPerRow: 5, isThumbsOneRow: "true", thumbsPosition: "bottom", firstThumbSelected: 0, isOneThumbShown: "false", colorActiveThumb: -1, zoomPosition: "right", speed: 400, easing: "linear", isKeypressEnabled: "true", colorIcons: -1 }; n.prototype = { init: function (b) {
        var a =
this; a.config = c.extend(!0, {}, n.defaults, b); a._options = b; "top" == a.config.thumbsPosition ? a.element.append("<div class='gc-display-area'><div class='gc-icon gc-icon-download'></div><div class='gc-icon gc-icon-next'></div><div class='gc-icon gc-icon-prev'></div><div class='gc-display-container'><div class='gc-lens gc-hide'></div><img class='gc-display-display' alt='Display Image' /></div></div>") : a.element.prepend("<div class='gc-display-area'><div class='gc-icon gc-icon-download'></div><div class='gc-icon gc-icon-next'></div><div class='gc-icon gc-icon-prev'></div><div class='gc-display-container'><div class='gc-lens gc-hide'></div><img class='gc-display-display' alt='Display Image' /></div></div>");
        a.element.prepend("<div class='gc-zoom gc-hide'><div class='gc-zoom-container'><img alt='Zoomed Image' /></div></div>"); a.element.prepend("<div class='gc-overlay-area gc-hide'><div class='gc-icon gc-icon-close'></div><div class='gc-icon gc-icon-next'></div><div class='gc-icon gc-icon-prev'></div><div class='gc-overlay-container'><img class='gc-overlay-display' alt='Overlay Image' /></div></div>"); a.gcLoader = c("<div class='gc-loading'></div>"); a.gcLoading = a.element.find(".gc-loading"); a.gcImgNaturalSizes =
[]; a.gcDisplayArea = a.element.find(".gc-display-area"); a.gcDisplayContainer = a.gcDisplayArea.find(".gc-display-container"); a.gcDisplayDisplay = a.gcDisplayContainer.find(".gc-display-display"); a.gcLens = a.gcDisplayContainer.find(".gc-lens"); a.gcDisplayDownload = a.gcDisplayArea.find(".gc-icon-download"); a.gcDisplayPrevious = a.gcDisplayArea.find(".gc-icon-prev"); a.gcDisplayNext = a.gcDisplayArea.find(".gc-icon-next"); a.gcZoom = a.element.find(".gc-zoom"); a.gcZoomContainer = a.gcZoom.find(".gc-zoom-container"); a.gcZoomDisplay =
a.gcZoomContainer.find("img"); a.gcOverlayArea = a.element.find(".gc-overlay-area"); a.gcOverlayContainer = a.gcOverlayArea.find(".gc-overlay-container"); a.gcOverlayDisplay = a.gcOverlayContainer.find(".gc-overlay-display"); a.gcOverlayPrevious = a.gcOverlayArea.find(".gc-icon-prev"); a.gcOverlayNext = a.gcOverlayArea.find(".gc-icon-next"); a.gcOverlayClose = a.gcOverlayArea.find(".gc-icon-close"); a.gcThumbsUl = a.element.find("ul"); a.gcThumbsUl.wrap("<div class='gc-thumbs-area'></div>"); a.gcThumbsArea = a.element.find(".gc-thumbs-area");
        a.gcThumbsArea.append("<div class='gc-thumbs-area-prev'><div class='gc-icon gc-icon-prev'></div></div><div class='gc-thumbs-area-next'><div class='gc-icon gc-icon-next'></div></div>"); a.gcThumbsAreaPrevious = a.gcThumbsArea.find(".gc-thumbs-area-prev"); a.gcThumbsPrevious = a.gcThumbsAreaPrevious.find(".gc-icon-prev"); a.gcThumbsAreaNext = a.gcThumbsArea.find(".gc-thumbs-area-next"); a.gcThumbsNext = a.gcThumbsAreaNext.find(".gc-icon-next"); a.gcThumbsLi = a.gcThumbsUl.find("li"); a.gcThumbsImg = a.gcThumbsLi.find("img");
        a.gcThumbsImg.wrap('<div class="gc-li-display-container"></div>'); a.gcThumbsLiDiv = a.gcThumbsLi.find(".gc-li-display-container"); a.gcTotalThumbsImg = a.gcThumbsImg.length; a.gcThumbsUl.removeClass("gc-start"); -1 != a.config.colorIcons && a.element.find(".gc-icon").css("color", a.config.colorIcons); b = { top: "", bottom: "", right: "", left: "" }; switch (a.config.downloadPosition) { case 1: b.top = 0; b.left = 0; break; case 2: b.top = 0; b.right = 0; break; case 4: b.bottom = 0; b.right = 0; break; default: b.bottom = 0, b.left = 0 } a.gcDisplayDownload.css(b);
        !1 == isNaN(a.config.firstThumbSelected) && -1 < parseFloat(a.config.firstThumbSelected) && parseFloat(a.config.firstThumbSelected); a.current = a.config.firstThumbSelected; a.currentSlide = Math.floor(a.current / a.config.nrThumbsPerRow); a.old = 0; a.currentMousePos = { x: -1, y: -1 }; "false" == a.config.isDownloadEnabled && a.gcDisplayDownload.addClass("gc-hide"); a.gcDisplayDisplay.attr("src", a.gcThumbsImg.eq(a.current).attr("src")); a.setup(); c.when(a.preloadImages()).done(function () { a.update(); a.initEvents() })
...
b) { this.width = a; this.height = b } var a = this, e = 0, f = a.gcTotalThumbsImg; return c.Deferred(function (m) {
    a.gcThumbsImg.each(function (d) {
        c("<img/>").attr("src", c(this).attr("src")).load(function () {
            var d = new b(this.width, this.height), h = a.gcThumbsLi.find("img[src*='" + c(this).attr("src") + "']").parents("li").index(); a.gcImgNaturalSizes[h] = d; a.setupThumbImg(a.gcThumbsLi.eq(h), h); a.removeLoader(a.gcThumbsLi.eq(h)); a.gcThumbsLi.eq(h).find(".gc-li-display-container").removeClass("gc-hide"); a.current == h && (a.removeLoader(a.gcDisplayArea),
a.gcDisplayContainer.removeClass("gc-hide"), a.setupDisplayDisplay(), a.setupLens()); ++e === f && m.resolve()
        })
    })
}).promise()
    }, setup: function () {
        this.setupDisplayArea(); "false" == this.config.isOneThumbShown && 1 == this.gcTotalThumbsImg ? (this.gcThumbsArea.addClass("gc-hide"), this.config.isKeypressEnabled = "false") : (this.config.isOneThumbShown = "true", this.setupThumbs()); 1 == this.gcTotalThumbsImg ? (this.gcOverlayPrevious.addClass("gc-hide"), this.gcOverlayNext.addClass("gc-hide")) : (this.gcOverlayPrevious.css("margin-top",
...
a)) : (b = c / f * a, this.gcDisplayArea.css("width", b))); this.gcDisplayPrevious.css("margin-top", -(this.gcDisplayPrevious.height() / 2)); this.gcDisplayNext.css("margin-top", -(this.gcDisplayNext.height() / 2)); 1 == this.gcTotalThumbsImg && (this.gcDisplayPrevious.addClass("gc-hide"), this.gcDisplayNext.addClass("gc-hide")); this.gcDisplayContainer.addClass("gc-hide"); this.addLoader(this.gcDisplayArea)
...
(this.gcThumbsUl.css("width", parseFloat(this.gcThumbsArea.css("width"))), a = Math.ceil((this.gcThumbsLi.length - 1) / this.config.nrThumbsPerRow), this.gcThumbsUl.css("height", Math.ceil(b * a + parseFloat(this.gcThumbsLi.css("margin-right")) * (a - 1)))); this.gcThumbsArea.css("height", Math.ceil(parseFloat(this.gcThumbsUl.css("height")))); "bottom" == this.config.thumbsPosition && (this.gcDisplayArea.css("top", "0"), this.gcThumbsArea.css("top", this.gcDisplayArea.outerHeight(!0)), this.gcThumbsArea.css("margin-top", ".2em"));
            "top" == this.config.thumbsPosition && (this.gcThumbsArea.css("top", "0"), this.gcDisplayArea.css("top", this.gcThumbsArea.outerHeight(!0)), this.gcDisplayArea.css("margin-top", ".2em")); "true" == this.config.isThumbsOneRow ? (this.gcThumbsAreaPrevious.removeClass("gc-hide"), this.gcThumbsAreaNext.removeClass("gc-hide"), this.gcThumbsPrevious.css("margin-top", -parseFloat(this.gcThumbsPrevious.css("height")) / 2), this.gcThumbsNext.css("margin-top", -parseFloat(this.gcThumbsNext.css("height")) / 2), this.setupSlider()) :
(this.gcThumbsAreaPrevious.addClass("gc-hide"), this.gcThumbsAreaNext.addClass("gc-hide"))
...
this.gcThumbsAreaNext.addClass("gc-disabled"))
        }, update: function () {
            -1 != this.config.colorActiveThumb && this.element.find(".gc-active").css("border-color", ""); this.gcThumbsLiDiv.removeClass("gc-active"); this.gcThumbsLiDiv.eq(this.current).addClass("gc-active"); -1 != this.config.colorActiveThumb && this.element.find(".gc-active").css("border-color", this.config.colorActiveThumb); this.gcDisplayDisplay.attr("src", this.gcThumbsLi.eq(this.current).find("img").attr("src")); this.setupDisplayDisplay(); this.setupZoom();
            this.setupLens(); this.setupZoomPos(); this.gcOverlayArea.hasClass("gc-hide") || (this.gcOverlayDisplay.attr("src", this.gcDisplayDisplay.attr("src")).attr("width", this.gcImgNaturalSizes[this.current].width).attr("height", this.gcImgNaturalSizes[this.current].height), this.gcOverlayDisplay.css("margin-left", -(this.gcOverlayDisplay.width() / 2)).css("margin-top", -(this.gcOverlayDisplay.height() / 2)))
        }, animateImage: function () {
            var b = this; b.isAnimating = !0; b.gcDisplayDisplay.animate({ opacity: .5 }, 200, function () {
                b.gcOverlayArea.hasClass("gc-hide") ||
b.gcOverlayDisplay.animate({ opacity: 0 }, 200, function () { b.update(); b.setupOverlay(); b.gcOverlayDisplay.animate({ opacity: 1 }, 500) }); b.gcOverlayArea.hasClass("gc-hide") && b.update(); b.gcDisplayDisplay.animate({ opacity: 1 }, 500, function () { b.gcZoomDisplay.attr("src", b.gcDisplayDisplay.attr("src")) }); b.isAnimating = !1
            })
...
c - d, g = -(parseFloat(this.gcZoomDisplay.css("width")) - parseFloat(this.gcZoom.css("width")))); this.gcLens.css("top", l); this.gcLens.css("left", h); this.gcZoomDisplay.css("top", n); this.gcZoomDisplay.css("left", g)
        ...
        }, mouseenterHandler: function (b) { var a = this; a.gcZoom.fadeIn(200, function () { a.gcLens.removeClass("gc-hide"); a.gcZoom.removeClass("gc-hide") }) }, mouseleaveHandler: function (b) { var a = this; a.gcLens.addClass("gc-hide"); a.gcZoom.fadeOut(200, function () { a.gcLens.addClass("gc-hide"); a.gcZoom.addClass("gc-hide") }) },
...
this.gcImgNaturalSizes[this.current].width ? this.gcOverlayDisplay.css("margin-left", -(parseFloat(this.gcOverlayContainer.css("width")) / 2)) : this.gcOverlayDisplay.css("margin-left", -(this.gcImgNaturalSizes[this.current].width / 2))
            ...
            var b = this; b.gcDisplayContainer.on("click.glasscase", function (a) { b.gcOverlayArea.removeClass("gc-hide"); b.setupOverlay(); c("body").addClass("gc-noscroll") }); b.gcDisplayContainer.on("mousemove.glasscase", c.proxy(b.mousemoveHandler, b)); b.gcDisplayContainer.on("mouseenter.glasscase",
c.proxy(b.mouseenterHandler, b)); b.gcDisplayContainer.on("mouseleave.glasscase", c.proxy(b.mouseleaveHandler, b)); b.gcDisplayDownload.on("click.glasscase", function (a) { a = d.createElement("canvas"); a.width = b.gcImgNaturalSizes[b.current].width; a.height = b.gcImgNaturalSizes[b.current].height; a.getContext("2d").drawImage(b.gcDisplayDisplay[0], 0, 0); new Blob; a.toBlob(function (a) { saveAs(a, b.gcDisplayDisplay.attr("src").replace(/^.*[\\\/]/, "")) }, "image/png") }); b.gcDisplayPrevious.on("click.glasscase", function (a) { b.previousImage() });
            b.gcDisplayNext.on("click.glasscase", function (a) { b.nextImage() }); b.gcOverlayPrevious.on("click.glasscase", function (a) { b.previousImage() }); b.gcOverlayNext.on("click.glasscase", function (a) { b.nextImage() }); b.gcOverlayClose.on("click.glasscase", function (a) { c("body").removeClass("gc-noscroll"); b.gcOverlayArea.addClass("gc-hide") }); c(d).on("keydown", function (a) {
                "true" == b.config.isKeypressEnabled && (37 == a.keyCode && b.previousImage(), 39 == a.keyCode && b.nextImage()); 27 == a.keyCode && (c("body").removeClass("gc-noscroll"),
b.gcOverlayArea.addClass("gc-hide"))
